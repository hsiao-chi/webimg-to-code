...
if __name__ == "__main__":
    ...
    # to_yolo_training_file(path.DATASET3_TRAINSET_ORIGIN_LIGHT_PNG, path.DATASET3_TRAINSET_FULL_YOLO_POSITION_TXT_PADDING_2, 300, path.DATASET3_TRAINSET_YOLO_TRAIN_TXT+"data3_full_yolo_300_padding_2"+TYPE.TXT)
    ...
    =================================================================================
    '''
    # createFolder(path.DATASET3_TRAINSET_NOISE_ATTR_YOLO_POSITION_TXT_PADDING)
    ...
    #     new_labels = []
    #     labels = read_file(
    #         path.DATASET3_TRAINSET_NOISE_FULL_YOLO_POSITION_TXT_PADDING+str(i)+TYPE.TXT, 'splitlines')
    #     for label in labels:
    #         c = int(label.split()[0])
    ...
    #     write_file(new_labels, path.DATASET3_TRAINSET_NOISE_ATTR_YOLO_POSITION_TXT_PADDING+str(i)+TYPE.TXT, 2)
...
#    new_positions_folder.replace('title', 'title [ text-dark ]')
    ...
    #     )
    replace_file_value(
        path.DATASET3_TRAINSET_YOLO_TRAIN_TXT+'data3_full_yolo_300_padding_2'+TYPE.TXT, 
        path.DATASET3_TRAINSET_YOLO_TRAIN_TXT+'data3_full_yolo_300_padding_2_lab'+TYPE.TXT,
        DATASET, DATASET_ANOTHER
        )
    # replace_file_value(
    ...
    # createFolder(path.DATASET3_TRAINSET_FULL_YOLO_POSITION_TXT_PADDING_2)
    # for i in range(0,400):
    #     lines=read_file(path.DATASET3_TRAINSET_FULL_YOLO_POSITION_TXT_PADDING+str(i)+TYPE.TXT, 'splitlines')
    #     new_lines=[]
    #     for line in lines:
    #         line = line.split()
    #         # if line[0] == '13':
    ...
    #     # print(new_lines)
    #     write_file(new_lines, path.DATASET3_TRAINSET_FULL_YOLO_POSITION_TXT_PADDING_2+str(i)+TYPE.TXT, dataDim=2)
