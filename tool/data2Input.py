...
def positionToSeq2SeqInput(num_total_data, encoder_file_folder, decoder_file_folder):
    ...
    for i in range(num_total_data):
        ...
        gui = readFile(decoder_file_folder, str(i), TYPE_TXT, 'splitBySpec')
        temp_data = []
...
if __name__ == "__main__":
    ...
    encoder_input_data, decoder_input_data = positionToSeq2SeqInput(num_total_data, PATH_PIX2CODE_DATASET+PIX2CODE_POSITION_FOLDER, PATH_PIX2CODE_DATASET+PIX2CODE_GUI_FOLDER)
