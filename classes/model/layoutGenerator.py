...
from keras.layers import Input, LSTM, Dense, GaussianNoise, Bidirectional
...
def seq2seq_train_model(num_input_token, num_target_token,
                        ...
                        weight_path=None, gaussian_noise=1, encoder_bidirectional_lstm=False, decoder_bidirectional_lstm=False):
